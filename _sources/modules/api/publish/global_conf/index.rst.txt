...
.. autoapisummary::
   ...
   publish.global_conf.autosummary_generate
   ...
   publish.global_conf.sass_src_dir
   publish.global_conf.sass_out_dir
   publish.global_conf.sass_filename
   publish.global_conf.sass_args
...
.. py:data:: extensions
   :value: ['sphinx.ext.autodoc', 'sphinx.ext.autosummary', 'sphinx.ext.extlinks',...
...
.. py:data:: sass_src_dir
   :value: 'themes/photon/static/scss'


.. py:data:: sass_out_dir
   :value: 'themes/photon/static/css'


.. py:data:: sass_filename
   :value: 'photon.scss'


.. py:data:: sass_args
   :value: ['--style', 'expanded']
